  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6">
        ...
        <article className="prose prose-invert prose-sm max-w-none bg-zinc-100 border border-zinc-200 rounded-lg p-6 overflow-x-auto">
          {current ? (
            <>
              <div className="flex items-center justify-between not-prose mb-4 pb-4 border-b border-zinc-200">
                <div>
                  <h2 className="text-lg font-bold text-zinc-900 m-0">
                    {current.title}
                  </h2>
