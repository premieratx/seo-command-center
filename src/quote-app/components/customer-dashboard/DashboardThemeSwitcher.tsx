        ...
        {THEMES.map((t) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs font-bold text-zinc-900 leading-tight truncate">{t.name}</p>
  ...
  switch (theme) {
    case "classic-navy":
      return {
        ...
        card: "bg-slate-800/70 border-sky-500/20 text-zinc-900",
    ...
    case "ivory-gold":
      return {
        ...
        tabActive: "bg-[#b8860b] text-zinc-900 data-[state=active]:bg-[#b8860b] data-[state=active]:text-zinc-900 shadow-md",
        tabInactive: "text-[#6b5b3e] data-[state=active]:bg-[#b8860b] data-[state=active]:text-zinc-900 hover:bg-[#ece3d0]",
        text: "text-[#2c2418]",
    ...
    case "charcoal-copper":
      return {
        page: "bg-zinc-100",
        header: "bg-zinc-200 border-b border-[#c67d4a]/20 shadow-lg",
        headerTitle: "text-[#e8e0d8]",
        headerSubtitle: "text-[#c67d4a]",
        card: "bg-zinc-200 border-zinc-300 text-[#e8e0d8] shadow-md",
        cardTitle: "text-[#c67d4a]",
        tabList: "bg-zinc-300 border border-[#c67d4a]/20",
        tabActive: "bg-[#c67d4a] text-zinc-900 data-[state=active]:bg-[#c67d4a] data-[state=active]:text-zinc-900 shadow-md",
        tabInactive: "text-[#a89888] data-[state=active]:bg-[#c67d4a] data-[state=active]:text-zinc-900 hover:bg-zinc-300",
        text: "text-[#e8e0d8]",
        textMuted: "text-[#8a8078]",
        textAccent: "text-[#c67d4a]",
        separator: "bg-zinc-300",
        summaryBg: "bg-zinc-200 border border-[#c67d4a]/20",
    ...
    case "pearl-sapphire":
      return {
        ...
        tabActive: "bg-[#1e40af] text-zinc-900 data-[state=active]:bg-[#1e40af] data-[state=active]:text-zinc-900 shadow-md",
        tabInactive: "text-[#3b5998] data-[state=active]:bg-[#1e40af] data-[state=active]:text-zinc-900 hover:bg-[#dbeafe]",
        text: "text-[#1e293b]",
    ...
    case "slate-emerald":
      return {
        ...
        tabActive: "bg-[#059669] text-zinc-900 data-[state=active]:bg-[#059669] data-[state=active]:text-zinc-900 shadow-md",
        tabInactive: "text-[#047857] data-[state=active]:bg-[#059669] data-[state=active]:text-zinc-900 hover:bg-[#d1fae5]",
        text: "text-[#1e293b]",
        textMuted: "text-[#64748b]",
    ...
    case "cream-burgundy":
      return {
        ...
        tabActive: "bg-[#7f1d1d] text-zinc-900 data-[state=active]:bg-[#7f1d1d] data-[state=active]:text-zinc-900 shadow-md",
        tabInactive: "text-[#991b1b] data-[state=active]:bg-[#7f1d1d] data-[state=active]:text-zinc-900 hover:bg-[#fde8e8]",
        text: "text-[#2d1b1b]",
    ...
    case "white-obsidian":
      return {
        ...
        card: "bg-white border-[#e4e4e7] text-zinc-100 shadow-sm",
        cardTitle: "text-zinc-100",
        tabList: "bg-[#f4f4f5] border border-[#e4e4e7]",
        tabActive: "bg-zinc-100 text-zinc-900 data-[state=active]:bg-zinc-100 data-[state=active]:text-zinc-900 shadow-md",
        tabInactive: "text-[#52525b] data-[state=active]:bg-zinc-100 data-[state=active]:text-zinc-900 hover:bg-[#e4e4e7]",
        text: "text-zinc-100",
        textMuted: "text-[#71717a]",
        textAccent: "text-zinc-100",
        separator: "bg-[#e4e4e7]",
        summaryBg: "bg-[#fafafa] border border-[#e4e4e7]",
        badge: "bg-zinc-100/10 text-zinc-100 border-zinc-200/20",
        logoSize: "h-10 w-10 sm:h-16 sm:w-16",
        font: "",
      };
    case "sandstone-teal":
      return {
        ...
        tabActive: "bg-[#0d7377] text-zinc-900 data-[state=active]:bg-[#0d7377] data-[state=active]:text-zinc-900 shadow-md",
        tabInactive: "text-[#0d7377]/80 data-[state=active]:bg-[#0d7377] data-[state=active]:text-zinc-900 hover:bg-[#ddd6c6]",
        text: "text-[#2c2a25]",
    ...
    case "frost-rose":
      return {
        ...
        card: "bg-white border-[#fce7f3]/60 text-zinc-100 shadow-sm",
        cardTitle: "text-[#be185d]",
        tabList: "bg-[#fff1f2] border border-[#fce7f3]/70",
        tabActive: "bg-[#be185d] text-zinc-900 data-[state=active]:bg-[#be185d] data-[state=active]:text-zinc-900 shadow-md",
        tabInactive: "text-[#be185d]/70 data-[state=active]:bg-[#be185d] data-[state=active]:text-zinc-900 hover:bg-[#fce7f3]",
        text: "text-zinc-100",
